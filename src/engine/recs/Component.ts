 ...
 * path:     packages/client/src/engine/recs/Component.ts
 * changes:  swap point 6 (DESIGN §4.1) — removed the React hook
 *           useComponentValue (with its react import) and the dead
 *           localStorage local-cache helpers getLocalCacheId /
 *           clearLocalCache / createLocalCache; pruned the imports that
 *           only they used (defineQuery/Has, isComponentUpdate, EntityID,
 *           useEffect/useState). Everything else is verbatim.
 */
